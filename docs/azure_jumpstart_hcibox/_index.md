...
| _C:\HCIBox\Logs\Deploy-ResourceBridge.log_ | Output of _Deploy-ResourceBridge.ps1_ which deploys and configures Arc resource bridge and builds gallery images. |
